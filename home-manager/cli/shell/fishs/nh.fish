#########################################
### nh command completions
### generated by `nh completions -s fish`
#########################################
...
complete -c nh -n "__fish_nh_using_subcommand os; and not __fish_seen_subcommand_from switch boot test build repl info" -s v -l verbose -d 'Show debug logs'
complete -c nh -n "__fish_nh_using_subcommand os; and not __fish_seen_subcommand_from switch boot test build repl info" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c nh -n "__fish_nh_using_subcommand os; and not __fish_seen_subcommand_from switch boot test build repl info" -f -a "switch" -d 'Build and activate the new configuration, and make it the boot default'
complete -c nh -n "__fish_nh_using_subcommand os; and not __fish_seen_subcommand_from switch boot test build repl info" -f -a "boot" -d 'Build the new configuration and make it the boot default'
complete -c nh -n "__fish_nh_using_subcommand os; and not __fish_seen_subcommand_from switch boot test build repl info" -f -a "test" -d 'Build and activate the new configuration'
complete -c nh -n "__fish_nh_using_subcommand os; and not __fish_seen_subcommand_from switch boot test build repl info" -f -a "build" -d 'Build the new configuration'
complete -c nh -n "__fish_nh_using_subcommand os; and not __fish_seen_subcommand_from switch boot test build repl info" -f -a "repl" -d 'Enter a Nix REPL with the target installable'
complete -c nh -n "__fish_nh_using_subcommand os; and not __fish_seen_subcommand_from switch boot test build repl info" -f -a "info" -d 'Show an overview of the system\'s info'
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from switch" -s o -l out-link -d 'Path to save the result link. Defaults to using a temporary directory' -r -F
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from switch" -s R -l bypass-root-check -d 'Bypass the check to call nh as root directly'
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from boot" -s o -l out-link -d 'Path to save the result link. Defaults to using a temporary directory' -r -F
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from boot" -s R -l bypass-root-check -d 'Bypass the check to call nh as root directly'
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from test" -s o -l out-link -d 'Path to save the result link. Defaults to using a temporary directory' -r -F
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from test" -s R -l bypass-root-check -d 'Bypass the check to call nh as root directly'
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from build" -s o -l out-link -d 'Path to save the result link. Defaults to using a temporary directory' -r -F
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from build" -s R -l bypass-root-check -d 'Bypass the check to call nh as root directly'
...
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from repl" -s H -l hostname -d 'Output to choose from the flakeref. Hostname is used by default' -r
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from repl" -s c -l configuration -d 'Name of the flake homeConfigurations attribute, like username@hostname' -r
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from repl" -s v -l verbose -d 'Show debug logs'
complete -c nh -n "__fish_nh_using_subcommand os; and __fish_seen_subcommand_from repl" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c nh -n "__fish_nh_using_subcommand home; and __fish_seen_subcommand_from switch" -s o -l out-link -d 'Path to save the result link. Defaults to using a temporary directory' -r -F
...
complete -c nh -n "__fish_nh_using_subcommand home; and __fish_seen_subcommand_from build" -s o -l out-link -d 'Path to save the result link. Defaults to using a temporary directory' -r -F
